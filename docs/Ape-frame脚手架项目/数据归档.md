...
![](./../%E6%AF%8F%E6%97%A5%E5%AE%8C%E6%88%90%E8%AE%A1%E5%88%92%E6%88%AA%E5%9B%BE/xxl-job/%E6%95%B0%E6%8D%AE%E5%BD%92%E6%A1%A3%E6%95%B4%E4%BD%93%E7%9B%AE%E5%BD%95.jpg)
...
* SysUserForwardHandler，继承自抽象模板AbstractBackUpDataHandler
  ...
  import com.york.user.mapper.SysUserBackMapper;
  import com.york.user.mapper.SysUserMapper;
  import lombok.extern.slf4j.Slf4j;
  import org.springframework.stereotype.Component;
...
**注意：**我们==可能有许多的场景==数据需要归档，那么如果我们一个个的写对应的归档Service会比较麻烦，那么我们可以很简单的将==所有的场景Handler==自动注入并生产Service吗？ —— 直接通过作为BackUpDataHandler子类自动注入工厂
...
/**
 * @author York
 * @className BackUpDataController
 * @date 2024/8/3
 * @description 数据归档Controller
 */
import com.york.user.db.BackUpDataSceneEnum;
import com.york.user.db.BackUpService;
